...
//    {
//        private static readonly string EncryptionKey = "YourDefaultKey12"; // Use same key that was used for encryption (16, 24, or 32 bytes)

//        // Decrypt Method
//        public static string Decrypt(string encryptedText)
//        {
//            byte[] key = Encoding.UTF8.GetBytes(EncryptionKey); // Ensure the key is of valid size (16, 24, or 32 bytes)
//            byte[] cipherText = Convert.FromBase64String(encryptedText); // Convert the encrypted text back from Base64

//            using (var aes = Aes.Create())
//            {
//                aes.Key = key;
//                aes.GenerateIV(); // AES requires an IV for decryption
